...
const Hero: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Create floating animation for icon
    ...
    <section className="relative pt-20 overflow-hidden min-h-screen flex flex-col justify-center">
      ...
      <div className="container mx-auto px-4 md:px-6 py-12 md:py-24 relative z-10">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          >
            <span className="gradient-text">Scan</span> the Market with <br /> 
          ...
          >
            Scan.fun gives you unprecedented insights into the trading activity of any Solana memecoin. Track the top traders, analyze their strategies, and make informed decisions.
          </motion.p>
      ...
      <div className="hero-icon absolute right-[10%] top-1/4 hidden md:block z-0">
        <motion.div
